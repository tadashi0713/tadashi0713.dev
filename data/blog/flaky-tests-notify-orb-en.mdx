...
images: https://res.cloudinary.com/tadashi0713/image/upload/v1661315964/tadashi0713.dev/flaky-tests-notify.png
---
...
We will pass this using Scheduled Pipeline.

## 3) Set up Scheduled Pipeline

To run this job regularly and

I added the parameter `notify_flaky_tests` so that this scheduled pipeline only triggers the `notify_flaky_tests` job.
