...
GameCI integrates with CircleCI by using an orb. With this orb, you can easily create CI/CD pipelines for Unity projects without writing a complex, custom build script from scratch.
