...
![Securely connect GitLab Self-managed to CircleCI using IP ranges](https://res.cloudinary.com/tadashi0713/image/upload/v1682243393/tadashi0713.dev/gitlab-ip-ranges.jpg)
...
To solve this problem, I will show you how to use the IP ranges feature provided by CircleCI to securely connect GitLab Self-managed to CircleCI based on IP addresses.
