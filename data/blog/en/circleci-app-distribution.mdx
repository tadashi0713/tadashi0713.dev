...
Add this Orb's command `upload_android` or `upload_ios` to CircleCI's CI/CD pipeline to build to iOS/Android platforms.
...
- Secure usage is possible, utilizing CircleCI's Artifact.
