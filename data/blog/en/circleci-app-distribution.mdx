...
CircleCI supports CI/CD pipelines of mobile applications, from building, testing, and releasing to the App Store / Play Store.

However, CircleCI alone could not distribute applications(mainly debug versions) for installing and debugging on iOS/Android devices.

Therefore, you need to integrate with CircleCI and other services such as [Firebase App Distribution](https://firebase.google.com/docs/app-distribution?hl=en) or [DeployGate](https://deploygate.com/?locale=en).

CircleCI App Distribution realizes these distributions only within CircleCI.
...
You need to create and save a GitHub Token ([GITHUB_TOKEN](<(https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens)>)) in advance.
...
- Easy to set up and use.
  ...
  - GitHub Pull Request comments (`comment_github_pr`) and Slack notifications (notify_slack) can be achieved with just a few lines of code.
...
### GitHub Pull Request Comments and Slack Notifications

When using GitHub Pull Request comments (comment_github_pr) and Slack notifications (notify_slack), execute upload_android or upload_ios in the same Job in the preceding steps.
...
- Support for GitLab Merge Requests and Bitbucket Pull Requests.
...
![Android architecture](https://res.cloudinary.com/tadashi0713/image/upload/v1704086206/tadashi0713.dev/cci-app-distribution-android.jpg)
